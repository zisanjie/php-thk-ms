...
<script type="text/javascript">
        ...
        <div class="maincontent">
        	<div class="contentinner">
                ...
                <div class="widgetcontent">
                	<form class="stdform" action="__APP__/Customers/ins" method="post">
						<p>
                            <label>ID</label>
                            <span class="field"><input type="text" name="id" class="input-xxlarge" placeholder="ID" /></span>
                        </p>
                         <p>
                            <label>用户名</label>
                            <span class="field"><input type="text" name="username" class="input-xxlarge" placeholder="用户名" /></span>
                        </p>
                        <p>
                            <label>密码</label>
                            <span class="field"><input type="password" name="userpwd" class="input-xxlarge" placeholder="密码" /></span>
                        </p>
                        <p>
                            <label>实名</label>
                            <span class="field"><input type="text" name="true_name" class="input-xxlarge" placeholder="实名" /></span>
                        </p>
						<p>
                            <label>车型</label>
                            <span class="field"><input type="text" name="car_type" class="input-xxlarge" placeholder="车型" /></span>
                        </p>
						<p>
                            <label>酒店</label>
                            <span class="field"><input type="text" name="hotel" class="input-xxlarge" placeholder="酒店" /></span>
                        </p>
						<p>
                            <label>电话</label>
                            <span class="field"><input type="text" name="phone" class="input-xxlarge" placeholder="电话" /></span>
                        </p>
						<p>
                            <label>email</label>
                            <span class="field"><input type="text" name="email" class="input-xxlarge" placeholder="Email" /></span>
                        </p>
						<p>
                            <label>pay</label>
                            <span class="field"><input type="text" name="pay" class="input-xxlarge" placeholder="支付" /></span>
                        </p>
						<p>
                            <label>积分</label>
                            <span class="field"><input type="text" name="score" class="input-xxlarge" placeholder="积分" /></span>
                        </p>
						<p>
                            <label>信誉度</label>
                            <span class="field"><input type="text" name="credit" class="input-xxlarge" placeholder="信誉度" /></span>
                        </p>
						<p>
                            <label>等级</label>
                            <span class="field"><input type="text" name="class" class="input-xxlarge" placeholder="等级" /></span>
                        </p>
						<p>
                            <label>关于司机</label>
                            <span class="field"><input type="text" name="about_drive" class="input-xxlarge" placeholder="关于司机" /></span>
                        </p>
						<p>
                            <label>好评</label>
                            <span class="field"><input type="text" name="favorite" class="input-xxlarge" placeholder="好评" /></span>
                        </p>
						<p>
                            <label>投诉</label>
                            <span class="field"><input type="text" name="complain" class="input-xxlarge" placeholder="投诉" /></span>
                        </p>
    ...
    <div class="footer">
        <div class="footerleft">Dcms Premium Admin Template v1.0</div>
        <div class="footerright">&copy; ThemePixels - <a href="http://www.qq.com">Follow me on Tencent</a> - <a href="http://www.sina.com.cn">Follow me on Sina</a></div>
    </div><!--footer-->
