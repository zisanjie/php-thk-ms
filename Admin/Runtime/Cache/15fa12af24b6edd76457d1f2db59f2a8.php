...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>酒店列表</h1> <span>用来显示所有酒店相关信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner">
            
            	<h4 class="widgettitle">酒店列表</h4>
                    ...
                    <tbody>
                    	<?php if(is_array($udata)): $i = 0; $__LIST__ = $udata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
							   ...
							   <td class="center">
                                    ...
                                    <td class="center">
                                            <?php if(empty($vo["star"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["star"]); endif; ?>
                                    </td>
									<td class="center">
									...
									<td class="center">
                                            <?php if(empty($vo["address"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["address"]); endif; ?>
                                    </td>
									<td class="center">
                                            <?php if(empty($vo["about"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["about"]); endif; ?>
                                    </td>
                                     <td class="center">
                                        <a href="__APP__/Hotels/editPage/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <span class="icon-edit"></span>
                                        </a>
                                    </td>
                                    <td class="center">
                                        <a href="__APP__/Hotels/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
