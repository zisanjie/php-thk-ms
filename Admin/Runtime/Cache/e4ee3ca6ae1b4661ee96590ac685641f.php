...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
            <h1>评论列表</h1> <span>用来显示所有用户评论信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
            
                <h4 class="widgettitle">评论列表</h4>
                <table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="center">车辆名</th>
                            <th class="center">评价分数</th>
                    ...
                    <tbody>
                        <?php if(is_array($edata)): $i = 0; $__LIST__ = $edata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                ...
                                <td>
                                    <?php if(($vo["content"] == '')): ?>无                     
                                    <?php else: echo (substr($vo["content"],0,20)); endif; ?>
                                </td>
                                 <td><?php echo (date("Y-m-d H:i:s",$vo["posttime"])); ?></td>
                                <td class="center">
                                    <a href="__APP__/Evaluate/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
