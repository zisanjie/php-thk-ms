    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">禁止登录</a> <span class="divider">/</span></li>
                <li class="active">添加IP</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
            <h1>添加IP</h1> <span>用来添加禁用IP信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
                <h4 class="widgettitle">添加IP</h4>
                <div class="widgetcontent">
                    <form class="stdform" action="__APP__/Ip/ins" method="post">
                        
                        <p>
                            <label>起始IP</label>
                            <span class="field">
                                <input type="text" class="input-xxlarge" data-validate="{required: true, messages:{required:'起始ip不能为空'}}" name="start_IP" id="start_IP" />
                            </span>
                        </p>
                        <p>
                            <label>结束IP</label>
                            <span class="field">
                                <input type="text" class="input-xxlarge" data-validate="{required: true, messages:{required:'起始ip不能为空'}}" name="end_IP" id="end_IP" />
                            </span>
                        </p>    
