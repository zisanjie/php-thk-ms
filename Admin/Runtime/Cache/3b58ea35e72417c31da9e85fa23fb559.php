        ...
        <div class="maincontent">
            <div class="contentinner">
                ...
                <div class="widgetcontent">
                    <form class="stdform" action="__APP__/Customers/mod" method="post" enctype="multipart/form-data">
                        ...
                        <p>
                            <label>密码</label>
							<span class="field">
                                <input type="password" name="userpwd" class="input-xxlarge" placeholder="userpwd"  value="<?php echo ($data["userpwd"]); ?>"/>
                            </span>
                        </p>
						<p>
                            <label>实名</label>
                            <span class="field">
                                <input type="text" name="true_name" class="input-xxlarge" placeholder="true_name"  value="<?php echo ($data["true_name"]); ?>"/>
                            </span>
                        </p>
						<p>
                            <label>车型</label>
                            <span class="field">
                                <input type="text" name="car_type" class="input-xxlarge" placeholder="car_type"  value="<?php echo ($data["car_type"]); ?>"/>
                            </span>
                        </p>
						<p>
                            <label>酒店</label>
                            <span class="field">
                                <input type="text" name="hotel" class="input-xxlarge" placeholder="hotel"  value="<?php echo ($data["hotel"]); ?>"/>
                            </span>
                        </p>
						<p>
                            <label>支付</label>
                            <span class="field">
                                <input type="text" name="pay" class="input-xxlarge" placeholder="pay"  value="<?php echo ($data["pay"]); ?>"/>
                            </span>
                        </p>
                        <p>
                            <label>phone</label>
						...
						<p>
                            <label>好评</label>
                            <span class="field">
                                <input type="text" name="favorite" class="input-xxlarge" placeholder="favorite"  value="<?php echo ($data["favorite"]); ?>"/>
                            </span>
                        </p>
						<p>
                            <label>投诉</label>
                            <span class="field">
                                <input type="text" name="complain" class="input-xxlarge" placeholder="complain"  value="<?php echo ($data["complain"]); ?>"/>
                            </span>
                        </p>
