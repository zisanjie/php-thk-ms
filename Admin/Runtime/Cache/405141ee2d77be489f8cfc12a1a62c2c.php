...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>一级分类列表</h1> <span>用来显示所有一级分类相关信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner">
            
            	<h4 class="widgettitle">一级分类列表</h4>
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                    	<?php if(is_array($bdata)): $i = 0; $__LIST__ = $bdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
	                            ...
	                            <td class="center"><?php echo ($vo["bname"]); ?></td>	                            
                                       <td class="left"><?php echo (substr($vo["describe"],0,50)); ?></td>
                                       <td class="center"><?php echo ($vo["orderno"]); ?></td> 
	                            <td class="center">
	                             	<a href="__APP__/Bclass/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
