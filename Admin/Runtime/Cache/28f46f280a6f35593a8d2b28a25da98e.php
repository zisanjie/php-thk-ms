    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">添加优惠</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
            <h1>添加优惠</h1> <span>用来添加优惠信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
                <h4 class="widgettitle">添加优惠</h4>
                <div class="widgetcontent">
                    <form class="stdform" action="__APP__/Foods/up" method="post">
                        
                        <p>
                            <label>车辆编号</label>
                            <span class="field">
                                <input type="text" name="id" class="input-xxlarge" placeholder="车辆编号" />
                            </span>
                        </p>                        
                        <p>
                            <label>优惠价格</label>
                            <span class="field"><input type="text" name="yprice" class="input-xxlarge" placeholder="优惠价格" value="<?php echo ($fdata["yprice"]); ?>" /></span>
                        </p>
                        <p>
                            <label>优惠时间</label>
                            <span>
                                <?php echo ($start_time); ?>-<?php echo ($endtime); ?>
                            </span>
