...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>单位列表</h1> <span>用来显示所有单位相关信息</span>
        </div><!--pagetitle-->
                    ...
                    <tbody>
                    	<?php if(is_array($udata)): $i = 0; $__LIST__ = $udata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
	                         ...
	                         <td class="center">
                                    ...
                                    <td class="center">
                                            <?php if(empty($vo["is_discount"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["is_discount"]); endif; ?>
                                    </td>
									<td class="center">
									...
									<td class="center">
                                     ...
                                     <td class="center">
                                        <a href="__APP__/Departments/editPage/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <span class="icon-edit"></span>
                                        </a>
                                    </td>
                                    <td class="center">
                                        <a href="__APP__/Departments/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
