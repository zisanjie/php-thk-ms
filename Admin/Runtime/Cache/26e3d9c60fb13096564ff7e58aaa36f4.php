    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">优惠管理</a> <span class="divider">/</span></li>
                <li class="active">进行中优惠</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
            <h1>进行中优惠</h1> <span>用来显示所有进行中的优惠车辆信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
            
                <h4 class="widgettitle">进行中优惠</h4>
                <table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                        <?php if(is_array($fdata)): $i = 0; $__LIST__ = $fdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                ...
                                <td class="center"><?php echo ($vo["yprice"]); ?></td>
                                <td class="center"><?php echo (date("Y-m-d H:i:s",$vo["start_time"])); ?></td>
                                <td class="center"><?php echo (date("Y-m-d H:i:s",$vo["end_time"])); ?></td> 
                                <td class="center">
                                    <a href="__APP__/Foods/delFav/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
