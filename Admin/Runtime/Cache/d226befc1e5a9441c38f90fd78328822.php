...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
            <h1>修改酒店</h1> <span>修改酒店信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
                <h4 class="widgettitle">修改酒店</h4>
                <div class="widgetcontent">
                    <form class="stdform" action="__APP__/Hotels/mod" method="post" enctype="multipart/form-data">
                        ...
                        <p>
                            <label>星级</label>
                            <span class="field">
                                <input type="text" name="star" class="input-xxlarge" placeholder="star"  value="<?php echo ($data["star"]); ?>"/>
                            </span>
                        </p>
						<p>
                            <label>好评</label>
                        ...
                        <p>
                            <label>关于</label>
                            <span class="field">
                                <input type="text" name="about" class="input-xxlarge" placeholder="about"  value="<?php echo ($data["about"]); ?>"/>
                            </span>
                        </p>
