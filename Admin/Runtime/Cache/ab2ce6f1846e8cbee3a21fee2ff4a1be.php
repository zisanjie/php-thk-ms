...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>用户列表</h1> <span>用来显示所有用户相关信息</span>
        </div><!--pagetitle-->
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                    	<?php if(is_array($udata)): $i = 0; $__LIST__ = $udata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
	                         ...
	                         <td class="center">
                                            <?php if(empty($vo["email"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["email"]); endif; ?>
                                    </td>
                                    <td class="center">
                                    ...
                                    <td class="center">
                                        <?php if(($vo["post"] == '1')): ?>允许                     
                                        <?php else: ?>不允许<?php endif; ?>
                                    </td>                                     
                                     <td class="center">
                                        <a href="__APP__/Users/editPage/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <span class="icon-edit"></span>
                                        </a>
                                    </td>
                                    <td class="center">
                                        <a href="__APP__/Users/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
