...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
            <h1>新订单</h1> <span>用来显示所有新订单信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
            
                <h4 class="widgettitle">新订单</h4>
                <table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="center">订车人</th>
                            <th class="center">接车地址</th> 
                            <th class="center">订车时间</th>
                    ...
                    <tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                ...
                                <td class="center"><?php echo ($vo["form_number"]); ?></td>
                                <td class="center"><?php echo ($vo["username"]); ?></td> 
                                <td class="center"><?php echo ($vo["address"]); ?></td>  
                                <td class="center"><?php echo (date("Y-m-d H:i:s",$vo["ftime"])); ?></td>
                                <td class="center"><?php echo ($vo["check"]==1?"通过":"不通过"); ?></td>
                                <td class="center">
                                    <a href="__APP__/Forms/details/form_number/<?php echo ($vo["form_number"]); ?>">详情</a>
                                </td>
                                <td class="center">
                                    <a href="__APP__/Forms/del/form_number/<?php echo ($vo["form_number"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
