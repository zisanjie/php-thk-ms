...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>客户列表</h1> <span>用来显示所有客户相关信息</span>
        </div><!--pagetitle-->
            	...
            	<table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="center">实名</th>
                            <th class="center">车型</th>
                            <th class="center">酒店</th>
							<th class="center">pay</th>
							<th class="center">phone</th>
							<th class="center">好评</th>
							<th class="center">投诉</th>
                            <th class="center">修改</th>
                            <th class="center">删除</th>                           
                        </tr>
                    </thead>
                    <tbody>
                    	<?php if(is_array($udata)): $i = 0; $__LIST__ = $udata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
	                         ...
	                         <td class="center">
                                            <?php if(empty($vo["true_name"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["true_name"]); endif; ?>
                                    </td>
									<td class="center">
                                            <?php if(empty($vo["car_type"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["car_type"]); endif; ?>
                                    </td>
                                    <td class="center">
                                            <?php if(empty($vo["hotel"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["hotel"]); endif; ?>
                                    </td>
                                    <td class="center">
                                            <?php if(empty($vo["pay"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["pay"]); endif; ?>
                                    </td>
									<td class="center">
                                            <?php if(empty($vo["phone"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["phone"]); endif; ?>
                                    </td>
									<td class="center">
                                            <?php if(empty($vo["favorite"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["favorite"]); endif; ?>
                                    </td>
									<td class="center">
                                            <?php if(empty($vo["complain"])): ?>未填写
                                            <?php else: ?> <?php echo ($vo["complain"]); endif; ?>
                                    </td>
                                     <td class="center">
                                        <a href="__APP__/Customers/editPage/id/<?php echo ($vo["id"]); ?>" title="修改">
                                        <span class="icon-edit"></span>
                                        </a>
                                    </td>
                                    <td class="center">
                                        <a href="__APP__/Customers/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');" title="删除">
