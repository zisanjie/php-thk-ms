    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
            ...
            <ul class="breadcrumb">
                ...
                <li><a href="#">日志管理</a> <span class="divider">/</span></li>
                <li class="active">日志列表</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
            <h1>日志列表</h1> <span>用来显示所有日志相关信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
            
                <h4 class="widgettitle">日志列表</h4>
                <table class="table table-bordered" id="dyntable">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th class="center">浏览车辆</th>
                            <th class="center">浏览时间</th>
                    ...
                    <tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                ...
                                <td class="center">
                                        <?php if(empty($vo["user"]["username"])): echo (long2ip($vo["ip"])); ?>
                                        <?php else: ?> <?php echo ($vo["user"]["username"]); endif; ?>
                                </td>
                                <td class="center"><?php echo ($vo["food"]["name"]); ?></td>
                                <td class="center"><?php echo (date("Y-m-d H:i:s",$vo["date"])); ?></td>
                                <td class="center"><?php echo ($vo["number"]); ?></td>
                                <td class="center">
                                    <a href="__APP__/Logs/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');">
