...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>管理员权限</h1> <span>用来修改管理员权限</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner">
                <h4 class="widgettitle">管理员权限</h4>
                <div class="widgetcontent">
                	<form class="stdform" action="__APP__/Roles/up" method="post">
                         <p>
                            <label>用户名</label>
                         ...
                         <p>
                            ...
                            <span class="field">
                                <select name="roles">
                                   <?php if(is_array($roles)): $i = 0; $__LIST__ = $roles;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($vo["id"] != '1')): ?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                                </select>
