    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
        	...
        	<ul class="breadcrumb">
                ...
                <li><a href="#">单位管理</a> <span class="divider">/</span></li>
                <li class="active">添加单位</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
        	<h1>添加单位</h1> <span>用来添加单位</span>
        </div><!--pagetitle-->
        ...
        <div class="maincontent">
        	<div class="contentinner">
                ...
                <div class="widgetcontent">
                	<form class="stdform" action="__APP__/Departments/ins" method="post">
						<p>
                            <label>ID</label>
                        ...
                        <p>
                            <label>单位名</label>
                            <span class="field"><input type="text" name="name" class="input-xxlarge" placeholder="单位名" /></span>
                        </p>
						<p>
                            <label>积分</label>
						...
						<p>
                            <label>折扣</label>
                            <span class="field"><input type="text" name="is_discount" class="input-xxlarge" placeholder="折扣" /></span>
                        </p>
						<p>
                            <label>电话</label>
						...
						<p>
                            <label>地址</label>
                            <span class="field"><input type="text" name="address" class="input-xxlarge" placeholder="地址" /></span>
                        </p>
						<p>
                            <label>关于</label>
                            <span class="field"><input type="text" name="about" class="input-xxlarge" placeholder="关于" /></span>
                        </p>
