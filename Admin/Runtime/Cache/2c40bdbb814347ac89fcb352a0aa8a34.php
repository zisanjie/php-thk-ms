...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
        	<h1>添加管理员</h1> <span>用来添加管理员</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
        	<div class="contentinner">
            	<h4 class="widgettitle">添加管理员</h4>
                <div class="widgetcontent">
                	<form class="stdform" action="__APP__/Users/ins" method="post">
                         <p>
                            <label>用户名</label>
                        ...
                        <p>
                            <label>联系方式</label>
                            <span class="field"><input type="text" name="phone" class="input-xxlarge" placeholder="联系方式" /></span>
                        </p>
