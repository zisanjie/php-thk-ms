...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
            <h1>修改单位</h1> <span>修改单位信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
                <h4 class="widgettitle">修改单位</h4>
                <div class="widgetcontent">
                    <form class="stdform" action="__APP__/Departments/mod" method="post" enctype="multipart/form-data">
						...
						<p>
                            <label>单位名</label>
                            <span class="field">
                                <input type="text" name="name" class="input-xxlarge" placeholder="name"  value="<?php echo ($data["name"]); ?>"/>
                            </span>
                        </p>
                        <p>
                            <label>密码</label>
