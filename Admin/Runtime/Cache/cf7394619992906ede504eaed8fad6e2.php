    ...
    <div class="rightpanel">
        ...
        <div class="breadcrumbwidget">
            ...
            <ul class="breadcrumb">
                ...
                <li class="active">禁用列表</li>
            </ul>
        </div><!--breadcrumbs-->
        <div class="pagetitle">
            <h1>禁用列表</h1> <span>用来显示所有已被禁用的用户的IP相关信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
            
                <h4 class="widgettitle">禁用列表</h4>
                <table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="gradeX">
                                ...
                                <td class="center"><?php echo (long2ip($vo["start_IP"])); ?></td>
                                <td class="center"><?php echo (long2ip($vo["end_IP"])); ?></td>
                                <td class="center">
                                    <a href="__APP__/Ip/del/id/<?php echo ($vo["id"]); ?>" onclick="return confirm('你确定要删除吗?');">
