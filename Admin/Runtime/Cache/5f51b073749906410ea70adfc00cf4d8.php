...
<script type="text/javascript">
    ...
    <div class="rightpanel">
        ...
        <div class="pagetitle">
            <h1>订单详情</h1> <span>用来显示订单详细信息</span>
        </div><!--pagetitle-->
        
        <div class="maincontent">
            <div class="contentinner">
            
                <h4 class="widgettitle">订单详情</h4>
                <table class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                        <tr>
                            <td>订单号</td>
                            <td><?php echo ($udata["form_number"]); ?></td>        
                            <td>订车人</td>                                                           
                            <td><?php echo ($udata["truename"]); ?></td>
                        </tr>
                         <tr>
                            <td>接车地址</td>
                        ...
                        <tr>                             
                            <td>订车时间</td>                                                           
                            <td>
                                    <?php echo (date("Y-m-d H:i:s",$udata["ftime"])); ?>                                   
                            </td>
                                                           
                            <td>订单状态</td>
                            <td>
                                <?php if($udata["status"] == 1 ): ?>进行中
                ...
                <table class="table table-bordered" id="dyntable">
                                ...
                                <tr>
                                    <td colspan="5" style="text-indent:2em;">
                                        总计:<?php echo ($udata["sum"]); ?>￥
                                    </td>
                                </tr>
                             </tbody>
                  </table>
