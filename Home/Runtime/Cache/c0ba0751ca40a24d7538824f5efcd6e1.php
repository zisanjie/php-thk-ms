...
<!-- 			<div class="left_top">
	<img src="__ROOT__/Uploads/Users/thumb/th_<?php echo (session('uheadpic')); ?>" style="width:200px; height:200px">
			...
			<div class="left_down">
				<ul>
					<a href="__URL__/index/pass" class="mpass"><li>单位资料</li></a>
					...
					<a href="__URL__/index/header" class="mheader"><li>单位介绍</li></a>
				</ul>
			</div>
		</div>
		<div id="main_right" class="main_right">
			...
			<div class="oper">
				<form action="__APP__/Dcenter/update" method="post" id="upSubmit">
					<div class="pass">
<!-- 						<p>
	<label>当前头像：</label>
	<span>
		<img src="__ROOT__/Uploads/Users/thumb/th_<?php echo (session('uheadpic')); ?>" style="width:85px;height:85px">
						...
						<p>
							<label>
							单位&nbsp;名称：<b style="color:#992222;margin-left:10px;">
								<?php echo (session('dname')); ?>
							</b></label>	
						</p>
						<p>
							<label>
						...
						<p>
							<label>合&nbsp;作酒&nbsp;店：
							<input style="margin-left:10px;" type="text" name="hotel" value="<?php echo (session('uhotel')); ?>"/>
							</label>
						</p>
						<p style="height:50px;">
				...
				<form action="__APP__/Dcenter/upaddress" method="post">
					<div class="address">
						<p>
							<label>订&nbsp;&nbsp;车&nbsp;&nbsp;人&nbsp;&nbsp;姓&nbsp;&nbsp;名：
					...
					<div class="money">
						<form action="__APP__/Dcenter/alterpwd/" method="post" id="regSubmit">
				...
				<div class="header">
				<form action="__APP__/Dcenter/upabout" method="post">
					<p style="margin-top:40px;">						
						<label>单位介绍：
						<textarea style="margin-left:60px;margin-top:20px;height:80px;width:550px;" name="about" value="<?php echo (session('utruename')); ?>"><?php echo (session('uabout')); ?></textarea></label>	
					</p>
					<p>
						<input type="hidden" name="id" value="<?php echo (session('uid')); ?>">
